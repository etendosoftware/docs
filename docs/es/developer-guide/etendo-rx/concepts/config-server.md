...
### Estructura YAML { #yaml-structure }
...
### Acceso a propiedades { #properties-access }
...
### Ejecución del servicio de configuración { #running-config-service }
...
### Cómo configurar una propiedad { #how-to-config-a-property }
