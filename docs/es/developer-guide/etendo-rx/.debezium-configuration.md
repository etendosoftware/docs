...
---
## Configuración de Debezium { #debezium-configuration }

### Configuración de Postgres { #postgres-configuration }
...
### Configuración de Debezium { #debezium-configuration_1 }
...
##### Verificación de Kafka { #kafka-verification }
