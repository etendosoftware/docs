...
# Cómo mejorar el reconocimiento OCR { #how-to-improve-ocr-recognition }
...
## Uso de un modelo específico { #using-a-specific-model }
...
## Uso de un prompt fijo { #using-a-fixed-prompt }
...
## Aumentar los DPI { #increasing-dpi }
...
## Uso de salida estructurada { #using-structured-output }
...
### Ejemplo: crear un esquema "Mail" { #example-creating-a-mail-schema }
...
## Añadir datos de referencia { #adding-reference-data }
