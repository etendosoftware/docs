...
----------
### Comprobación de dependencias { #checking-dependencies }
...
### Creación del hook { #hook-creation }
...
#### Funciones y estados exportados { #functions-and-states-exported }
...
----------
### Llamada al hook { #calling-the-hook }
...
### Descarga del PDF { #downloading-the-pdf }
...
### Previsualización del PDF { #previewing-the-pdf }
