...
# Cómo crear un proceso basado en Java (obsoleto) { #how-to-create-a-java-based-process-deprecated }
...
### Declaración de la clase Java { #java-class-declaration }
...
### Definición de la interfaz de usuario { #defining-the-user-interface }
...
### Añadir el formulario del proceso al menú { #add-the-process-form-to-the-menu }
...
## Variante: ejecutar el proceso desde un botón en otra ventana { #variant-running-the-process-from-a-button-in-another-window }
...
#### 1. Añadir una columna a la tabla utilizada por la ventana de destino { #1-add-a-column-to-the-table-used-by-the-target-window }
...
#### 2. Configurar la columna como un botón vinculado a su proceso { #2-configure-the-column-as-a-button-linked-to-your-process }
...
#### 3. Exponer el botón en la ventana { #3-expose-the-button-in-the-window }
...
#### 4. Usar el botón en la UI { #4-use-the-button-in-the-ui }
...
## Variante: patrón de UI manual { #variant-manual-ui-pattern }
