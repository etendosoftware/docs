...
# Cómo actualizar una biblioteca { #how-to-upgrade-a-library }
...
### Compatibilidad de versión de JDK { #jdk-version-compatibility }
...
### Compatibilidad de licencia { #license-compatibility }
...
### Comprobar cambios en la API { #check-for-api-changes }
...
#### Comprobar compatibilidad del código fuente { #check-source-compatibility }
...
#### Comprobar cómo afectan estos cambios a los módulos publicados { #check-how-these-changes-affect-published-modules }
...
##### Añadir una nueva biblioteca { #adding-a-new-library }
...
#### Publicar cambios en la API { #publish-api-changes }

En caso de que haya cambios en la API, publíquelos en la wiki siguiendo el proceso definido.

### Actualizar la carpeta ` legal ` { #update-legal-folder }
...
### Actualizar el archivo .classpath { #update-the-classpath-file }
...
### Actualizar la wiki { #update-wiki }
