...
## Tabla en el Diccionario de Aplicación { #tables-in-application-dictionary }
...
### Nomenclatura de tablas { #table-naming }
...
## Columnas en el Diccionario de Aplicación { #columns-in-application-dictionary }
...
### Nomenclatura de columnas { #column-naming }
...
### Definición de objetos de negocio: el isParent { #defining-business-objects-the-isparent }
...
#### Tipos de Referencias { #types-of-references }
...
##### Referencias base { #base-references }
...
#### Referencias base del core { #core-base-references }

Las siguientes secciones describen las referencias base definidas en el core.

##### Referencias numéricas { #numeric-references }
...
##### Referencias de texto { #text-references }
...
##### Referencias de tiempo { #time-references }
...
##### Referencia Sí/No { #yesno-reference }
...
###### Botones DocAction { #docaction-buttons }
...
###### Botones de contabilización { #post-buttons }
...
###### Cuándo usar listas { #when-to-use-lists }
...
###### Cuándo usar referencia de tabla { #when-to-use-table-reference }
...
###### Definir una referencia de tabla { #defining-a-table-reference }
...
###### Cuándo usar referencia de selector { #when-to-use-search-reference }
...
##### Contraseña (no descifrable) { #password-not-decryptable }
...
##### Contraseña (descifrable) { #password-decryptable }
...
#### Referencias en módulos { #references-in-modules }
...
#### Definir una validación { #defining-a-validation }
...
#### Definición de un identificador de registro { #defining-a-record-identifier }
...
##### Qué pueden hacer los Callouts { #what-callouts-can-do }
...
##### Definir un Callout { #defining-a-callout }
...
###### Diccionario de aplicación { #application-dictionary }
...
###### Ejecutar en Nuevo { #execute-on-new }
