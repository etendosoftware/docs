...
Bienvenido al primer paso para entender los sistemas de **Enterprise Resource Planning (ERP)**: potentes herramientas que están en el corazón de la gestión empresarial moderna.

Esta sección te ayuda a comprender qué es un ERP, cómo funciona y por qué es esencial para organizaciones de cualquier tamaño.
...
-   :material-sale:{ .lg .middle } __[Gestión de Ventas](../user-guide/etendo-classic/basic-features/sales-management/getting-started.md)__
...
-   :material-shopping:{ .lg .middle } __[Gestión de Aprovisionamiento](../user-guide/etendo-classic/basic-features/procurement-management/getting-started.md)__
    ...
    - Coordina con **Producción** y **Finance**.
...
- **Centralized Information**: Todos tus datos críticos en un único lugar.  
- **Informed Decision-Making**: Los cuadros de mando e informes ayudan a los responsables a actuar con rapidez.  
- **Process Automation**: Reduce tareas manuales, ahorrando tiempo y esfuerzo.  
- **Scalability**: Crece con tu negocio.  
- **Regulatory Compliance**: Etendo ayuda a cumplir estándares locales e internacionales.
...
-  **Document Everything**: Mantén bien documentadas todas las nuevas funcionalidades y cambios.  
-  **Train Continuously**: Asegura que todos los usuarios sepan utilizar el sistema de forma efectiva.  
