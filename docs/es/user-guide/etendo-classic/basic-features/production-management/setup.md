...
[:material-file-document-outline: Área](#área){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Puesto Trabajo](#puesto-trabajo){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Plan de Producción](#plan-de-producción){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Proceso](#proceso_1){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Utillajes](#utillajes_2){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Tipo de Máquina](#tipo-de-máquina){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Máquina](#máquina_1){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Centro de Costos](#centro-de-costos){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Costo Indirecto](#costo-indirecto_2){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Control Periódico](#control-periódico){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Punto de Control Crítico](#punto-de-control-crítico){ .md-button .md-button--primary } <br>
...
!!! warning
    Si el mantenimiento de máquinas se gestiona en un sistema externo, vaya a la ventana [Consumo interno](transactions.md#internal-consumption) para mantener actualizado el stock de repuestos en Etendo, incluso cuando se utilice otro software.  
...
- This work is a derivative of [Gestión de Producción](http://wiki.openbravo.com/wiki/Production_Management){target="_blank"} by [Openbravo S.L.U](http://wiki.openbravo.com/wiki/Welcome_to_Openbravo){target="_blank"}, licensed under [CC BY-SA 2.5 ES](https://creativecommons.org/licenses/by-sa/2.5/es/){target="_blank"}.
