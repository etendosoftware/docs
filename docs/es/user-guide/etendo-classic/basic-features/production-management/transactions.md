...
## Orden de Fabricación { #work-requirement }
...
### Parte de Trabajo { #work-effort_1 }
...
### Parte de Fabricación { #production-run }
...
### Categoría Salarial / Empleado { #salary-category-employee }
...
### Cómo reactivar Partes de Trabajo { #how-to-reactivate-work-efforts }
...
### Cómo anular Partes de Trabajo { #how-to-void-work-efforts }
...
## Parte de Fabricación { #production-run_1 }
...
### Parte de Fabricación { #production-run_2 }
...
### Categoría Salarial / Operarios { #salary-category-employee_1 }
...
## Toma de Datos de PCC { #quality-control-report }
...
## Datos del control de calidad periódico { #periodic-quality-control-data }
...
### Ventana Datos del control de calidad periódico { #periodic-quality-control-data-window }
...
### Cómo reactivar Consumo interno { #how-to-reactivate-internal-consumption }
...
!!! info
    Para más información, visite [Contabilización masiva](../../../../user-guide/etendo-classic/optional-features/bundles/financial-extensions/bulk-posting.md) en la documentación del Financial Extensions Bundle.
## Parte de Mantenimiento { #maintenance-order }
...
## Insertar Mantenimientos { #insert-maintenances }
...
## Mantenimiento Programado { #maintenance-plan }
...
## Calcular costo estándar { #calculate-standard-costs }
