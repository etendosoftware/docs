...
- [Factura (Proveedor)](../procurement-management/transactions/purchase-invoice.md): documento utilizado para administrar una obligación de pago. El documento lista los bienes y/o servicios proporcionados por un proveedor.
