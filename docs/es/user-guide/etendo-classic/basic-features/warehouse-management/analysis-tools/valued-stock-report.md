...
-   **Almacén**: Si la organización seleccionada es "Generic", entonces se listan todos los almacenes que le pertenecen; en caso contrario, si la organización es "Legal with accounting", no se muestra ningún almacén para seleccionar.
