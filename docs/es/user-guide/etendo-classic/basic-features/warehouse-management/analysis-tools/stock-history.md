...
La ventana Historial de existencias solo se rellena mediante el proceso en segundo plano "Create Stock History". Puede programarse desde la ventana "Procesamiento de solicitudes", donde se puede asignar para qué rol y organización se ejecuta, y la periodicidad con la que se ejecuta.
...
![Historial de existencias](../../../../../assets/drive/10C8VIJpu2FJkojmrZ8aKCZMZo0D0OpMJ.png)

La ventana muestra los siguientes campos con los que el usuario puede filtrar y obtener los datos necesarios: 
- Fecha de stock 
- Producto
...
![Historial de existencias](../../../../../assets/drive/1MhFI0Ii9bhm8EBBK-UalKWK90_-Gkm_G.png)
