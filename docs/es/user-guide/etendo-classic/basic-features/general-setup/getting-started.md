...
Lo anterior significa que determinadas configuraciones como Usuario, clientes, proveedores y otros [datos maestros](../master-data-management/master-data/overview.md) pueden gestionarse en una entidad y, por lo tanto, estar disponibles en todas las organizaciones dentro de la entidad.
