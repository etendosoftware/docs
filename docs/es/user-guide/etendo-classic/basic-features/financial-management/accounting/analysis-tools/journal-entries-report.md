...
- un rango **De la Cuenta/A la Cuenta** para mostrar los asientos contables que tengan al menos una línea con una cuenta definida en el rango.
...
- el **"Número de Entrada Inicial"** a mostrar en el formato PDF del informe
...
Por último, y de la misma manera que para el resto de informes financieros, el informe Diario asientos puede generarse en:
