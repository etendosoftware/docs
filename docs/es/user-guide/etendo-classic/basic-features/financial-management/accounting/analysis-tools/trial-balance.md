...
:material-menu: `Aplicación` > `Gestión Financiera` > `Contabilidad` > `Herramientas de Análisis` > `Balance de Comprobación`
...
El **Balance de Comprobación** verifica que el total de débitos sea igual al total de créditos.
...
- **Organización**: La organización para la que se genera el Balance de Comprobación. Puede generarse para:
...
- **Importe de Asiento de Apertura al Saldo Inicial**: Esta opción está seleccionada por defecto. Controla cómo se muestra el saldo de apertura (p. ej., 1 de enero de 2021) en el informe:
...
- **Desde Cuenta / Hasta Cuenta**: Permite especificar un rango de subcuentas a incluir en el informe (solo disponible cuando el nivel de cuenta está configurado como *Subcuenta*).

### Dimensiones

Es posible refinar el informe de Balance de Comprobación seleccionando **Dimensiones** adicionales, como:
...
- **Incluir Cifras en Cero**: Cuando está activado, el informe muestra todas las subcuentas, incluidas las que tienen saldos en cero.
