...
Además de las **Opciones de Informes** anteriores:

- Libro mayor
- Informe General Contabilidad
- Organización
- Nivel de Cuenta
- Mostrar Solo Cuentas con Valor (casilla)
- Mostrar Códigos de Cuenta (casilla)
- Mostrar Modo Apaisado (casilla)

Se han añadido las siguientes dimensiones:
...
Además, en adición a los **Filtros primarios** anteriores:

- Año
- A la Fecha (solo para Balance de situación)
- Fecha de inicio (solo para Pérdidas y ganancias)
- Fecha de fin (solo para Pérdidas y ganancias)
- Comparar Con (casilla)
- Año de Referencia
- A la Fecha de Referencia (solo para Balance de situación)
- Desde la Fecha de Referencia (solo para Pérdidas y ganancias)
- Hasta la Fecha de Referencia (solo para Pérdidas y ganancias)
- Número de Página Inicial, impreso en el informe.


!!! info 
    - Ahora es posible comparar hasta **cuatro años** simultáneamente.
...
![](../../../../../../assets/user-guide/etendo-classic/basic-features/financial-management/accounting/analysis-tools/balance-sheet-and-pl-structure-advanced/balance-sheet-and-pl-structure-advanced-2.png)

**Ejemplo de informe de P&L**

![alt text](../../../../../../assets/user-guide/etendo-classic/basic-features/financial-management/accounting/analysis-tools/balance-sheet-and-pl-structure-advanced/balance-sheet-and-pl-structure-advanced-3.png)
