...
La información del plan de pago de la factura de ventas se muestra agrupada en dos secciones.
...
- **Importe Bruto Total**. Es el Importe total de la Factura.
- **Importe Pendiente**. Es el Importe pendiente de este Plan de Pago.
- **Moneda**. Es la Moneda de la Factura.

La sección **Plan de Pago** muestra la siguiente información detallada:

- **Método de Pago**. Es el método de pago de la factura de ventas.
- **Fecha de Vencimiento**. Es la "Fecha de Vencimiento" original acordada con el cliente. Esta fecha se usa como "Fecha de Referencia" en algunos Informes Financieros, como el Análisis de Antigüedad de Créditos.
...
Es el número de días desde la fecha esperada hasta el día actual.
