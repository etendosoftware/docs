...
![Ventana Remesa](../../../../../assets/user-guide/etendo-classic/basic-features/financial-management/receivables-and-payables/transactions/remittance-window.png)
...
=== "Remesa Sin Descuento"
    ...
    **Ejemplo**
    ...
    #### Liquidar/Protestar Remesa

    Una vez que el banco confirma los pagos correspondientes, acceda a la ventana "Liquidar/Protestar Remesas" y verifique las remesas liquidadas y protestadas.
