...
- **Método de Pago**. Es el método de pago de la factura de compra.
- **Fecha de Vencimiento**. Es la "Fecha de Vencimiento" original acordada con el proveedor. Esta fecha se usa como "Fecha de Referencia" en algunos Informes Financieros.
- **Fecha Esperada**. Es la Fecha en que se espera que se realice el pago. Cuando se crea el Plan de Pago, esta fecha es la misma que la "Fecha de Vencimiento", pero puede modificarse posteriormente.  
