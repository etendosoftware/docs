...
La ventana del algoritmo de reconciliación lista y permite al usuario configurar el/los algoritmo/s que se utilizarán al asociar las líneas del extracto bancario con las transacciones de la cuenta financiera.
...
-   **Coincidir nombre del tercero:** Esta opción obtiene una coincidencia sólida si el nombre del tercero de la línea del extracto bancario coincide con el nombre del tercero de la transacción de la cuenta financiera.
-   **Coincidir referencia:** Esta opción obtiene una coincidencia sólida si la referencia de la línea del extracto bancario coincide con la referencia de la transacción de la cuenta financiera.
-   **Coincidir fecha de transacción:** Esta opción obtiene una coincidencia sólida si el nombre del tercero de la línea del extracto bancario coincide con el nombre del tercero de la transacción de la cuenta financiera.
