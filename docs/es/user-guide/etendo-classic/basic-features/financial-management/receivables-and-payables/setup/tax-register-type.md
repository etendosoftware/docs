...
Los tipos de registro de impuesto son una variable clave del proceso de Pago del impuesto, ya que es este proceso el que calcula el importe total de impuestos de cada tipo de registro de impuesto creado y configurado.

En otras palabras, el proceso "Pago del impuesto" ayuda a calcular el importe de impuestos a pagar a la autoridad tributaria correspondiente o a recibir de ella, como la diferencia entre:
...
Por lo tanto, no solo es posible configurar los tipos impositivos que el proceso de pago del impuesto tomará como parte de un tipo de registro de impuesto, sino también los tipos de documento que se tendrán en cuenta.
