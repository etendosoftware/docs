...
-   **Mostrar deuda dudosa** (Opcional). Esta casilla de verificación ofrece al usuario la opción de mostrar información sobre deudas dudosas en el informe.
...
-   **Tercero**. Un tercero con cobros pendientes. También es un enlace a la versión detallada del informe para ese tercero.
...
-   **Primer rango de días**. El importe que el tercero debe a la organización, vencido y cuya fecha de vencimiento se encuentra dentro del rango.
...
-   **Créditos**. Importe de dinero que el tercero tiene disponible como crédito para uso posterior. El importe aparece entre paréntesis porque debe restarse al calcular los totales.
-   **Neto**. Total - Crédito del tercero.

Si los créditos se contabilizan en la misma cuenta que las cuentas a cobrar, el Neto coincidirá con el saldo del tercero. Si los créditos se contabilizan en una cuenta diferente, como los anticipos, el saldo del tercero coincidirá con el Total.

Si la casilla de verificación **Mostrar deuda dudosa** está marcada, se muestran dos campos adicionales:

-   **Deuda dudosa**. El importe clasificado como deuda dudosa para ese tercero en particular.
-   **Porcentaje**. El porcentaje que representa la deuda dudosa sobre la deuda neta de ese tercero en particular.
...
-   **Neto a cobrar**. El importe pendiente de la factura a la fecha. Es la suma de los importes de los rangos de fechas de vencimiento pasadas.
...
Si los créditos se contabilizan en la misma cuenta que las cuentas a cobrar, el Neto a cobrar total coincidirá con el saldo del tercero. Si los créditos se contabilizan en una cuenta diferente, como los anticipos, el saldo del tercero coincidirá con el Neto a cobrar total más los créditos (deshaciendo la resta de los créditos al total).

Además, existe una línea de resumen para todos los terceros.

Si la casilla de verificación **Mostrar deuda dudosa** está marcada, se muestran dos campos adicionales:

-   **Deuda dudosa**. El importe clasificado como deuda dudosa para esa factura en particular.
-   **Porcentaje**. El porcentaje que representa la deuda dudosa sobre el Neto a cobrar de esa factura en particular.
