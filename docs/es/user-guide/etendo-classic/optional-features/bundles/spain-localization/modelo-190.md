...
Esta sección explica el contenido y funcionamiento del módulo **"Modelo 190"**, incluido dentro del bundle de Localización Española para Etendo.
...
-   Importante, antes de aplicar esta configuración es importante haber aplicado previamente la configuración del módulo de impuestos, puesto que el Modelo 190 depende de este.
...
-   se ha creado un nuevo informe, el modelo 190 anual que se encuentra en la ruta de aplicación: Gestión Financiera || Contabilidad || Configuración || Declaración de impuestos, tal y como se muestra en la siguiente imagen:  
     
...
-   los rangos de impuestos se han asociado al correspondiente Parámetro del informe 190, con el fin de que las transacciones ligadas a dichos impuestos completadas y contabilizadas en el sistema se tengan en cuenta en una u otra casilla/posición del fichero, tal y como se muestra en la siguiente imagen:  
     
...
Sin embargo, si usted desea incluir esta información en su declaración, tan solo debe importar el fichero generado por Etendo como se indica en [_Modelo 190_](https://sede.agenciatributaria.gob.es/Sede/ayuda/consultas-informaticas/declaraciones-informativas-ayuda-tecnica/modelos-190-198/modelo-190-formulario.html){target="_blank"}.

### **Tipos de documentos y retenciones que se incluyen en el informe**

El modelo 190 es un informe de retenciones, así que solo se tendrán en cuenta facturas de compra con retenciones a terceros ubicados en España que estén contabilizadas y pagadas (parcialmente o completamente).

Dentro de las facturas de compra, se soporta todo el rango disponible actualmente:

-   Facturas de compra (factura AP)
-   Facturas de abono de compra (abono AP)
-   Facturas de compra negativas (facturas AP negativas)
-   Facturas de tipo "Reversión" (factura de compra revertida)
...
-   por ejemplo, si tenemos una factura contabilizada pero pagada en un 50% en 2011, el informe del 190 de 2011 incluirá la parte proporcional de la retención practicada en la factura, esto es, el 50%.
...
Una vez generado el fichero, este tendrá que cargarse en la AEAT en la página correspondiente de [Agencia Tributaria](https://sede.agenciatributaria.gob.es/Sede/procedimientoini/GI10.shtml){target="_blank"}.

 ---

Este trabajo es una obra derivada de [Openbravo Localización Española](https://wiki.openbravo.com/wiki/Openbravo_Localizaci%C3%B3n_Espa%C3%B1a){target="\_blank"} de [Openbravo Wiki](http://wiki.openbravo.com/wiki/Welcome_to_Openbravo){target="\_blank"}, usada bajo licencia [CC BY-SA 2.5 ES](https://creativecommons.org/licenses/by-sa/2.5/es/){target="\_blank"}. Esta obra está licenciada bajo [CC BY-SA 2.5](https://creativecommons.org/licenses/by-sa/2.5/){target="\_blank"} por [Etendo](https://etendo.software){target="\_blank"}.