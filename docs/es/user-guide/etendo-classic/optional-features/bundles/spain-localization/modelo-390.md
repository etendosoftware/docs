...
:octicons-package-16: Paquete Java: `org.openbravo.module.aeat390.es`
...
-   Operaciones específicas - Operaciones realizadas en el ejercicio
    ...
    -   Entregas de bienes y prestación de servicios en RECC, criterio de devengo art. 75 LIVA
    -   Adquisiciones de bienes y servicios en RECC, criterio de devengo art. 75 LIVA

A diferencia de otros modelos tributarios, este fichero XML no se puede importar en ningún software de la AEAT para su previsualización y edición.
...
-   Impuestos: configuración para España (Impuestos para España)
-   Lanzador de informes de impuestos
-   Provincias de España
-   Epígrafes del I.A.E.
-   Representante legal de la organización (representante legal de la organización)
...
Los módulos del Modelo AEAT 390 incluyen un "conjunto de datos" o "configuración" que relaciona los tipos/rangos de impuestos para España, incluidos los de IVA de Caja, con los parámetros de declaración del 390.
...
2. Cada rango de impuestos del módulo de impuestos para España se asocia con el parámetro de declaración del Modelo 390 correspondiente, con el fin de que las transacciones ligadas a dichos impuestos completadas y contabilizadas en el sistema, se tengan en cuenta en una u otra casilla/nodo del fichero XML, tal y como se muestra en la siguiente imagen: 
...
En la imagen del ejemplo se muestra cómo las bases imponibles/cuotas ligadas al rango de impuesto "Entregas IVA 21%" se reflejarán en las casillas correspondientes del 390 relacionadas con:
...
Si su organización tiene uno o varios representantes legales debe declararlos en la solapa correspondiente de la ventana Organización, que está disponible al instalar el módulo Representante legal de la organización (representante legal de la organización).
