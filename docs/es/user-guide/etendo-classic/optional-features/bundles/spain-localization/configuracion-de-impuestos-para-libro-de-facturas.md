...
Este identificador es útil al solicitar soporte técnico o al verificar que el módulo correcto está instalado en el sistema.
...
Una vez instalado y aplicado este módulo, se puede comprobar la configuración de los libros en la ruta de aplicación: Gestión Financiera/ Contabilidad/ Configuración/ Configuración de Libro de Facturas, tal y como se muestra en la siguiente imagen:
...
Este dataset cubre exactamente los siguientes siete tipos de documento estándar de Etendo:

- AP Invoice (Factura de Proveedor)
- AP CreditMemo (Abono de Proveedor)
- AR Invoice (Factura de Cliente)
- AR CreditMemo (Abono de Cliente)
- Reversed Purchase Invoice (Factura de Compra Anulada)
- Reversed Sales Invoice (Factura de Venta Anulada)
- Return Material Sales Invoice (Devolución de Venta)
...
Para consultar qué tipos de impuesto de IVA de Caja están disponibles en tu sistema, consulta [Impuestos IVA de Caja](../../../../../user-guide/etendo-classic/optional-features/bundles/spain-localization/iva-de-caja.md).
