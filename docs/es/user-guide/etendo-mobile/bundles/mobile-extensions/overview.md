...
La **Subapp Documents Manager** es una implementación de subaplicación de ejemplo capaz de recibir archivos externos y renderizarlos dentro de Etendo Mobile.

!!! note
    La aplicación admite diferentes formatos de imágenes, audio, PDF, CSV y txt. Aunque en iPadOS puede estar limitado.

!!! info
    Para más información técnica, visite [Crear nueva subaplicación - Recepción de archivos compartidos desde Etendo Mobile](../../../../developer-guide/etendo-mobile/tutorials/create-new-subapplication.md#receiving-shared-files-from-etendo-mobile).
