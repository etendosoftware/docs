...
Esta sección detalla las mejoras de la interfaz de usuario disponibles en la **Etendo New UI**.

## Mejoras y ampliaciones de la UI de Etendo

### Formato regional de fechas

Todas las fechas mostradas en la interfaz de usuario ahora se adaptan automáticamente a la configuración regional de tu navegador. Esto proporciona una vista personalizada y localizada de la información de fechas, haciendo la interfaz más intuitiva y fácil de leer para usuarios de diferentes regiones.
...
La **UI de Etendo** introduce un sistema de gestión de adjuntos completamente rediseñado que proporciona una forma más ágil, visual y completa de gestionar archivos adjuntos, tanto desde la **vista de formulario** como directamente desde los **registros de la cuadrícula**.
...
1. **Arrastrar y soltar:** arrastra uno o varios archivos directamente desde tu ordenador a la **zona de suelta** punteada en la sección de adjuntos.
...
**Funciones dentro de la vista previa:**
...
#### Subida rápida desde la cuadrícula (arrastrar y soltar en filas)
...
El modal de **Filtros avanzados** es un potente componente de filtrado que permite a los usuarios crear filtros complejos de múltiples condiciones directamente desde la interfaz de la cuadrícula. Proporciona una forma intuitiva de construir consultas sofisticadas usando operadores lógicos y múltiples grupos de filtros.

!!! info "Características clave"
    - **Múltiples tipos de filtro:** soporte para campos de tipo cadena, número, fecha, booleano y selección.
    ...
    - **Añadir/eliminar condiciones:** añade o elimina dinámicamente condiciones de filtro individuales.
    - **Añadir/eliminar grupos:** crea grupos de filtros anidados para organizar lógica compleja.
    - **Borrar todo:** restablece todos los filtros para empezar de nuevo.
...
1. **Haz clic en el icono de filtro** en la cabecera de la cuadrícula para abrir el modal de Filtros avanzados.
...
9. **Limpia los filtros** haciendo clic en el botón *Borrar todo* para restablecer y empezar de nuevo.
