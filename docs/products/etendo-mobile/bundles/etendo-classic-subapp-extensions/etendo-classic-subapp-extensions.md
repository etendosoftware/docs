...
To add the windows to be shown in the subapp must be configured entering the Etendo Classic under the role “administrator” in Role>Access in windows and checking the box “show in mobile” in the required windows.
...
!!! info
    ...
    Afer that you only should configurate the aplication and version you want to see for each role in the Dynamic App tab in [Role](/docs/products/etendo-classic/user-guide/general-setup/security/#dynamic-app) window.
