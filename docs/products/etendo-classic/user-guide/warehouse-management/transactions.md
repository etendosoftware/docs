...
![](/docs/assets/drive/12r6iycSYJzLIVpgBrp3xG8CSxd13L-eZ.png)
...
![Header](/docs/assets/drive/1mrD0K5quoU7vF0d3WNeOwW0u_n4vGLWf.png)
...
![Header 2](/docs/assets/drive/1CWBqL3eiqKbFJ8RTqSJaf1iB2_ltvJp3.png)
...
![Header](/docs/assets/drive/1kfjIQpgySwJygR6UxhnTHrLbFkseEEDf.png)
...
![Header](/docs/assets/drive/170LDHuomqrUcv0OHXssJuBjXJlyzg8H0.png)
...
![Lines](/docs/assets/drive/18SSKl05H6kTiVvZfZteK0MeJnb787F6p.png)
...
![Goods Transaction](/docs/assets/drive/1rGnZndz2vH5AEMTbBc1xVao-TLFT1N_r.png)
...
![Stock](/docs/assets/drive/1Z_fxaBhzcUR2exlgB69BDletxVUl_fiL.png)
...
![Stock](/docs/assets/drive/1U6xkkgtOgdwovTAP70Fo6JLSbfIf-UOZ.png)
...
![Stock](/docs/assets/drive/1F6npvraIMx78-uaccl5Ibmqj8yY46wMX.png)
...
![Header](/docs/assets/drive/159RjgB2ff5cOtrsCcE0TxlbT6WyEtVWz.png)
...
![Lines](/docs/assets/drive/1Y-fYqIyNmSDOIwtEW9bqoKgALlRbyv7M.png)
...
![Inventories](/docs/assets/drive/1Hk2DRSMCFD4FQ5HPkVnIOhbsRioCKeFS.png)
...
![Cost adjustment](/docs/assets/drive/1nLK6s6vSfV3C3rDRIjFq2dVRGCi1S-t4.png)
...
| [_Product Asset_](/docs/products/etendo-classic/user-guide/master-data-management/master-data#accounting)                            |                                                  | Adjustment amount of "Movement To" transaction |
...
| [_Product Asset_](/docs/products/etendo-classic/user-guide/master-data-management/master-data#accounting)                            |                   | Adjustment amount |
...
![Cost adjustment](/docs/assets/drive/18dMx0odX-PVVwMCGGtEnkfYNfctDa7o5.png)
...
| ------------------------------------------------------------------------------- | ------------------------------- | ------------------------------- |
| Account                                                                         | Debit                           | Credit                          |
| [_Product Asset_](/docs/products/etendo-classic/user-guide/master-data-management/master-data#accounting)            | Goods Receipt Adjustment amount |                                 |
| [_Invoice Price Difference_](/docs/products/etendo-classic/user-guide/master-data-management/master-data#accounting) |                                 | Goods Receipt Adjustment amount |
...
| ------------------------------------------------------------------------- | -------------------------------- | -------------------------------- |
| Account                                                                   | Debit                            | Credit                           |
| [_Cost of Goods Sold_](/docs/products/etendo-classic/user-guide/master-data-management/master-data#accounting) | Goods Shipment Adjustment amount |                                  |
| [_Product Asset_](/docs/products/etendo-classic/user-guide/master-data-management/master-data#accounting)      |                                  | Goods Shipment Adjustment amount |
...
![Cost adjustment](/docs/assets/drive/1vta9aBh20mSzCWRvr4jHKjwNMa5QtEyk.png)
...
![Cost adjustment](/docs/assets/drive/1VeXLRgA1XTypzkIYGOloEycvI7i138Pi.png)
...
![Box](/docs/assets/drive/1JQfT41NnGHscmbx1FygnOuvFwxi3co5v.png)
