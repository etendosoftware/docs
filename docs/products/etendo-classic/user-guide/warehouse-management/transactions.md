...
![](/assets/drive/12r6iycSYJzLIVpgBrp3xG8CSxd13L-eZ.png)
...
- [Procurement Management](/products/etendo-classic/user-guide/procurement-management/transactions) as goods received change stock quantity and its value.
- [Sales Management](/products/etendo-classic/user-guide/sales-management/transactions) as shipment changes stock quantity and its value.
- [Production Management](/products/etendo-classic/user-guide/production-management/transactions) because raw materials are taken out of the warehouse and produced goods are sent back to the stock during the production process.
...
For more information, visit [Sales Order](/products/etendo-classic/user-guide/sales-management/transactions#sales-order).
...
For more information, visit [Purchase Order](/products/etendo-classic/user-guide/procurement-management/transactions#purchase-order).
...
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------ | ---------------------------------------------- |
| Account                                                                                         | Debit                                            | Credit                                         |
| [_Warehouse Differences_](/products/etendo-classic/user-guide/financial-management/accounting/setup#defaults) | Adjustment amount of "Movement From" transaction |                                                |
| [_Product Asset_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting)                            |                                                  | Adjustment amount of "Movement To" transaction |
...
| Account                                                                                         | Debit                                          | Credit                                         |
| [_Product Asset_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting)                            | Adjustment amount of "Movement To" transaction |                                                |
| [_Warehouse Differences_](/products/etendo-classic/user-guide/financial-management/accounting/setup#defaults) |                                                | Adjustment amount of "Movement To" transaction |
...
| ----------------------------------------------------------------------------------------------- | ----------------- | ----------------- |
| Account                                                                                         | Debit             | Credit            |
| [_Warehouse Differences_](/products/etendo-classic/user-guide/financial-management/accounting/setup#defaults) | Adjustment amount |                   |
| [_Product Asset_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting)                            |                   | Adjustment amount |
...
| ------------------------------------------------------------------------------- | ------------------------------- | ------------------------------- |
| Account                                                                         | Debit                           | Credit                          |
| [_Product Asset_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting)            | Goods Receipt Adjustment amount |                                 |
| [_Invoice Price Difference_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting) |                                 | Goods Receipt Adjustment amount |
...
| ------------------------------------------------------------------------- | -------------------------------- | -------------------------------- |
| Account                                                                   | Debit                            | Credit                           |
| [_Cost of Goods Sold_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting) | Goods Shipment Adjustment amount |                                  |
| [_Product Asset_](/products/etendo-classic/user-guide/master-data-management/master-data#accounting)      |                                  | Goods Shipment Adjustment amount |
