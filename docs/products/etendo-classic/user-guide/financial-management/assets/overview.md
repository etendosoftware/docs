...
[:material-file-document-outline: Assets](/products/etendo-classic/user-guide/financial-management/assets/overview/#assets){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Asset Group](/products/etendo-classic/user-guide/financial-management/assets/overview/#asset-group){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Amortization](/products/etendo-classic/user-guide/financial-management/assets/overview/#amortization){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Asset Amortization Report (Excel)](/products/etendo-classic/user-guide/financial-management/assets/overview/#amortization-report){ .md-button .md-button--primary } <br>
