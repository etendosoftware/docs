...
[:material-file-document-outline: Financial Type Configuration](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#financial-type-configuration){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Simple G/L Journal](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#simple-gl-journal){ .md-button .md-button--primary } <br>

[:material-file-document-outline: G/L Journal](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#gl-journal){ .md-button .md-button--primary } <br>

[:material-file-document-outline: End Year Close](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#end-year-close){ .md-button .md-button--primary } <br>

[:material-file-document-outline: GL Posting by DB Tables ](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#gl-posting-by-db-tables){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Budget](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#budget){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Create Budget Reports in Excel](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#create-budget-reports-in-excel){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Not Posted Transaction Report](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#not-posted-transaction-report){ .md-button .md-button--primary } <br>

[:material-file-document-outline: Reset Accounting](/docs/products/etendo-classic/user-guide/financial-management/accounting/transactions/#reset-accounting){ .md-button .md-button--primary } <br>
...
![](/docs/assets/drive/10-YHo9nG7tBwph55ag0oNzkhqgbkfihr.png)
...
### Accounting 
 ...
 ![](/docs/assets/drive/1eQLGjpM9vAMRCbo4_gh2-J9Nc6yd36lU.png)
...
![](/docs/assets/drive/1-laz4Iz4Vr4bWWskpQvNTOjMnOU0RrVO.png)
...
- **Cost Center**: If indicated in the header, the cost center is shown in this field. If not, it can be manually indicated.
 ...
 ![](/docs/assets/drive/14Ih3VtN49OvT6_mFvoqD6aRl0-2Q6Zo6.png)
 
 ![](/docs/assets/drive/1xWW0_nVq1kjh_cumMvK21HnEfDFr_bxu.png)
...
- **Cost Center**: If indicated in the header, the cost center is shown in this field. If not, it can be manually indicated.
 ...
 ![](/docs/assets/drive/1VZWhH1uWsjLVMD3PcGRLL-PAsUATljDu.png)
 
 ![](/docs/assets/drive/1qzAFpd3xnZ-HdM8QYZkeRiTPrFtCZ156.png)
...
- **Cost Center**: If indicated in the header, the cost center is shown in this field. If not, it can be manually indicated.
 ...
 ![](/docs/assets/drive/1kTCqTfIYwvMIWkPpe1pYTg862Igm509S.png)
 
 ![](/docs/assets/drive/1iog1B9hLNu48VixtuTNFBI7LILxLsGKT.png)
...
**Loan**:
 ...
 ![](/docs/assets/drive/1OCunghF0jWITNTUxMFgM6CEhrQpnvgjX.png)
 
**Leasing**:
 
 
 ![](/docs/assets/drive/1pediSQ58EVWkA619-VY80W9AyrzlTHtz.png)

 
**Renting**:

 ![](/docs/assets/drive/1bEcDIiMM9bYTVIFcNW4_No-Dbd19NaGE.png)
...
![](/docs/assets/drive/1K6HHmJ723s2BMk5o-FKH34n6dEs6uo1E.png)
...
![](/docs/assets/drive/1jG0EQ3FQ8NWJeo6oIXJfY8msx80tyMJU.png)

![](/docs/assets/drive/1W5brf7TNC5rUNhZmtIftjtGoBocJjX2N.png)
...
![](/docs/assets/drive/15ivJAiL2y4phrUGAatnzasqFpzC384U_.png)
...
![](/docs/assets/drive/185JazYlxodMfPSx-2B4RgVe9UVadeUks.png)
...
![](/docs/assets/drive/1QAaLd-Rkiay5X6sKozqV80H7ykVoes53.png)
...
![](/docs/assets/drive/1l7-FyYg87NhJheS_L7GTATeJsvvoA41K.png)

##### Reverse GL Journal

![](/docs/assets/drive/1tZDhsR7UlZUz7itZlxDBVouv9QHIj-_G.png)
...
![](/docs/assets/drive/1Uec9_qgFGGKWDLNsWvN7CZDwuQXAjp0J.png)
...
![](/docs/assets/drive/1dR_rouWq3IFHDFHv_CBfLdywl7lBkLQz.png)
...
![](/docs/assets/drive/1FoRVJ89HIyQt4zO2WhyYkSm3riRyKGpx.png)
...
![](/docs/assets/drive/137QIrGJeaxPlR9pTnhh0delXq_Xwqt0y.png)
...
![](/docs/assets/drive/1O9MpaLX0Ewh-OI8GW3z1h8E9ERRqoOQ4.png)

2- Create a new record:

![](/docs/assets/drive/1mxbJexaQrgCCMkvjYdJILcAmCb8Y8ohF.png)
...
![](/docs/assets/drive/194RVxWW4vIWYQVLBrgYBi2P8ADNOH0bR.png)
...
![](/docs/assets/drive/1cwaYerXmbWqaJu5HXlH8-yoaxvrf5935.png)
...
![](/docs/assets/drive/1jJr_ZWLzgVbkF1mXz835JWRVBQhQcJ_l.png)
...
![](/docs/assets/drive/1CMGcvXoHxCcfYwskpj4OOwC_XBaPWDG0.png)
...
![](/docs/assets/drive/1RflwaoqNOmVWf7b6_Bo5MFeO_KlJqg1-.png)
...
![](/docs/assets/drive/1aYBdLPYhLuzH26wsAf2zzFeaEcWS5Eab.png)
...
![](/docs/assets/drive/1UE0WYDFJLdbDQkApYSinHkXYyM4p-1Hr.png)
...
![](/docs/assets/drive/17enHOwaYF9EQ3HyoN2pkBbsEPYhMLpwF.png)
...
![](/docs/assets/drive/1ttBuhupxE9YYwts1jvL2qSmu9tGwleUx.png)

2021 Profit and Loss:

![](/docs/assets/drive/1F6LMtj4tZdBSdt1yKsYhoO4Tv8nxyiGH.png)
...
-   and dated on the latest day of the year (31-12-2019) below entry as a Retained Earnings account is defined for the organization's general ledger:
 ![](/docs/assets/drive/1KRK07-Dtm1eikqZ7ERqOv1poDAvUfOzB.png .png)
     
...
![](/docs/assets/drive/1SEPkTkQEu25sszL7ZUxhOnI9HK3-d6ON.png)
...
-   Dated on the latest day of the year (31-12-2019) below **P&L Closing Entry**.  
 ...
 ![](/docs/assets/drive/113QOGZVS2BuV29KMcUvMYHVS1fRyHW4B.png .png)
     
-   Dated on the latest day of the year (31-12-2019) below **Closing Entry**.  
 ...
 ![](/docs/assets/drive/1Y0yGWcULssKJaRjezhwZ8-ZgBlunEcjm.png .png)
     
-   Dated on the day of the following year (01-01-2020) below **Opening Entry**.  
 ...
 ![](/docs/assets/drive/1lZ1pLSan1bButlXguyX9126egixcQAqu.png .png)
     
...
-   Dated on the latest day of the year (31-12-2019) below **P&L Closing Entry**:
 ![](/docs/assets/drive/1LaHkcA8oefBywLCDFCJBBFN4x2cHYFHW.png .png)
     
-   and dated on the latest day of the year (31-12-2019) below entry as a Retained Earnings account is defined for the organization's general ledger:
 ![](/docs/assets/drive/18CrpHbC5hgoLYFKInsO201y-MzQT2AG5.png .png)
...
![](/docs/assets/drive/1tAh4RfUDcPvDgSG9PeBYX79MhpW-csWW.png)
...
![](/docs/assets/drive/1nfPHEpviK8sRPB5BEZbSM4xYx32HgHeX.png)
...
![](/docs/assets/drive/1FStSn-NWyajDwRZQ6xki_owQLql2FOyy.png)
...
![](/docs/assets/drive/1Svc4hFmQRQA1s1IeQx9-po1KhrxpEeZ7.png)
...
![](/docs/assets/drive/1dFKDra_iDbmeMrzC8n3M94m8uPqhokNk.png)
