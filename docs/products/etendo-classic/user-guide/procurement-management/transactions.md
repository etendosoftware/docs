...
!!! info
    To learn how to enter purchase order lines, visit the next section [Lines](/docs.etendo.software/products/etendo-classic/user-guide/procurement-management/transactions/#lines_2).
...
!!! info
    For more information, visit [the Intercompany module user guide](/docs.etendo.software/products/etendo-classic/optional-features/bundles/financial-extensions/intercompany).
...
!!! info
    To learn how to enter goods receipt lines, visit the next section [Lines](/docs.etendo.software/products/etendo-classic/user-guide/procurement-management/transactions/#lines_3)
...
!!! warning
    Note: It is not possible to reactivate documents that include transactions with quantities exceeding the existing stock quantity for a certain product in a certain storage bin. The only exception is when the configuration of the storage bin allows Over Issue. For more information, visit [Storage Bin](/docs.etendo.software/products/etendo-classic/user-guide/warehouse-management/setup#storage-bin).
