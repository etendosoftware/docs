...
!!! info
    For more information, visit [Advanced Business Partner](/products/etendo-classic/optional-features/bundles/essentials-extensions/advanced-business-partner/) in the Essentials Extensions Bundle Documentation.
...
!!! info
    To learn more about this workflow, visit [Financial Account](/products/etendo-classic/user-guide/financial-management/receivables-and-payables/transactions/#financial-account).
...
- **Price List** - the one selected will be the one applied while creating sales documents such as sales orders or sales invoices for that customer.  
  To learn more, visit [Price List](/products/etendo-classic/user-guide/master-data-management/pricing/#price-list).  
...
- **Payment method** - the one selected will be the one applied while creating and managing the payments received from that customer.  
  ...
  To learn more, visit [Payment Method](/products/etendo-classic/user-guide/financial-management/receivables-and-payables/transactions/#payment-method).
- **Payment Terms** - the one selected will be the one used while managing sales invoices payment plan.  
  To learn more, visit [Payment Term](/products/etendo-classic/user-guide/master-data-management/business-partner-setup/#payment-term).
- **Financial account** - the one selected will be the one use while collecting and reconciling the payments made by that customer.  
  To learn more about "Financial Account", visit [Financial Account](/products/etendo-classic/user-guide/financial-management/receivables-and-payables/transactions/#financial-account).
- **Invoice terms** - there are few invoice terms which can be used while generating sales invoices.  
  To learn more, visit [Generate Invoices](/products/etendo-classic/user-guide/sales-management/transactions/#generate-invoices).
  ...
  - **Customer Schedule after Delivery** - the invoice will be generated according to the calendar agreed with the customer and once the goods ordered have been shipped.  
    ...
    To learn more, visit [Invoice Schedule](/products/etendo-classic/user-guide/master-data-management/business-partner-setup/#invoice-schedule)
...
- **SO BP Tax Category** - this field can be found under the "More Information" section.  
  ...
  To learn more, visit [Business Partner Tax Category](/products/etendo-classic/user-guide/financial-management/accounting/setup/#business-partner-tax-category)
...
To learn more, visit [Sales Invoice](/products/etendo-classic/user-guide/sales-management/transactions/#sales-invoice).
...
- **Financial account** - the one selected will be the one used while withdrawing and reconciling the payments made to a supplier.  
  To learn more, visit [Financial Account](/products/etendo-classic/user-guide/financial-management/receivables-and-payables/transactions/#financial-account).
- **Tax Category** - you can use a business partner tax category to get that the purchase documents registered from a vendor can only have a specific set of tax rates linked to that tax category.  
  To learn more, visit [Tax Category](/products/etendo-classic/user-guide/financial-management/accounting/setup/#tax-category).
...
!!! info
    For more information, visit [Rappel Configurations](/products/etendo-classic/user-guide/master-data-management/business-partner-setup/#rappel-configurations).
...
!!! info
    For more information, visit [Sales Invoice](/products/etendo-classic/user-guide/sales-management/transactions/#sales-invoice).
...
- **Production** checkbox is selected if the product is part of a production process. Once selected, an additional field appears to select a "Process Plan".  
  To learn more, visit [Process Plan](/products/etendo-classic/user-guide/production-management/setup/#process-plan)
