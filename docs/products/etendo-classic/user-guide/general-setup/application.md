...
!!! info
    For more information visit the [Etendo Mobile](/products/etendo-mobile/getting-started/) documentation.

### Header

![](/assets/products/etendo-classic/user-guide/general-setup/application/HeaderDynamicApp.png)
...
![](/assets/products/etendo-classic/user-guide/general-setup/application/DynamicAppVersion.png)
...
Finally, configure this application in the [Role Configuration](/products/etendo-classic/user-guide/general-setup/security/#dynamic-app).
