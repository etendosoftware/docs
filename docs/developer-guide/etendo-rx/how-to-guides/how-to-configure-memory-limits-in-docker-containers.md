...
|                                |                            | Das           | das.memory.limit               | 2.0        | BASE_DAS_MEMORY_LIMIT             | 512M          |
...
|                                |                            | Kafka         | kafka.memory.limit             | 4.0        | BASE_KAFKA_MEMORY_LIMIT           | 1G            |
|                                |                            | Connect       | connect.memory.limit           | 4.0        | BASE_CONNECT_MEMORY_LIMIT         | 1G            |
...
| com.etendoerp.tomcat.yml        | tomcat.base.memory.mb      | Tomcat        | tomcat.memory.limit            | 2.0        | BASE_TOMCAT_MEMORY_LIMIT          | 512M          |
...
| com.etendoerp.etendorx_utils.yml | utils.base.cpu    | Kafka-ui      | kafka.ui.cpu.limit             | 0.5        | BASE_KAFKA_UI_CPU_LIMIT           | 0.5           |
|                                |                   | Jaeger        | jaeger.cpu.limit               | 0.5        | BASE_JAEGER_CPU_LIMIT             | 0.5           |
|                                |                   | Jaeger-health | jaeger.health.cpu.limit        | 0.5        | BASE_JAEGER_HEALTH_CPU_LIMIT      | 0.5           |
