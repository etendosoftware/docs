...
!!! info "Prerequisites"
    - Etendo Copilot is installed and running.
    - At least one agent is configured in the Agent window.
    - You have an Etendo session token or OAuth-capable MCP client credentials.

### Step 1: Get the MCP configuration snippet
...
3.  **Configure connection options**:
    ...
    <figure markdown="span">
      ![MCP Configuration Dialog](../../../assets/developer-guide/etendo-copilot/how-to-guides/how-to-use-an-agent-as-mcp-server/how-to-use-an-agent-as-mcp-server-1.png)
      <figcaption>MCP configuration dialog showing connection mode, authentication type and optional custom values.</figcaption>
    </figure>
    ...
    !!! info "Authentication Type"
        ...
        **Token in Header**
        ...
        - Sends the token through the `etendo-token` custom HTTP header.
...
4.  **Copy the generated configuration** from the popup.
    ...
    <figure markdown="span">
      ![MCP Generated Configuration](../../../assets/developer-guide/etendo-copilot/how-to-guides/how-to-use-an-agent-as-mcp-server/how-to-use-an-agent-as-mcp-server-2.png)
      <figcaption>Generated MCP configuration snippet ready to copy and paste into the client configuration file.</figcaption>
    </figure>

### Step 2: Configure your client

Choose the example that matches your client and the selected **Authentication Type**.
...
4. **If you selected OAuth 2.1**:
    ...
    2. Enter your username and password.
        ...
        <figure markdown="span">
          ![Etendo login page showing username and password fields with Use default role and organization checkbox](../../../assets/developer-guide/etendo-copilot/how-to-guides/how-to-use-an-agent-as-mcp-server/how-to-use-an-agent-as-mcp-server-3.png)
          <figcaption>Etendo OAuth login page: enter username and password, then optionally enable Use default role and organization.</figcaption>
        </figure>
    ...
    5. On the second page, select a **Role** and an **Organization**.
        ...
        <figure markdown="span">
          ![Role and Organization selection page in the Etendo OAuth login flow](../../../assets/developer-guide/etendo-copilot/how-to-guides/how-to-use-an-agent-as-mcp-server/how-to-use-an-agent-as-mcp-server-4.png)
          <figcaption>Role and Organization selection screen shown when Use default role and organization is not enabled.</figcaption>
        </figure>
...
- If you are using token-based authentication and receive a 401 error, regenerate the Etendo session token. Send a `POST` request to `/etendo/sws/login` with a JSON body containing `username` and `password`. The response returns a new token. Update the token in the client configuration afterwards.
...
[:material-file-document-outline: How to Configure MCP Servers on Etendo Agents](how-to-configure-mcp-servers-on-agents.md){ .md-button .md-button--primary }

[:material-file-document-outline: How to Create an Agent](how-to-create-an-agent.md){ .md-button .md-button--primary }

[:material-file-document-outline: How to Configure API Tokens for Etendo Copilot](how-to-configure-api-tokens.md){ .md-button .md-button--primary }
