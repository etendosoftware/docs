...
The **docs** directory contains Etendo's API documentation, which can be generated using the [Javadoc](https://www.oracle.com/java/technologies/){target="\_blank"} tool. This documentation can be generated by executing the command `ant generate.java.doc`.
...
The **referencedata** directory contains implementation specific reference data such as accounting structures, reports, product lists or price lists etc. Reference data modules are a convenient way to load reference data into Etendo. More information about this can be found [here](../concepts/datasets.md).
...
The **src-core** directory contains the source code of the core components: XmlEngine (View), [SQLC](../concepts/sqlc.md) (Model), HttpBaseServlet (Controller) and ConnectionPool.   
...
the `ant diagnostic` task from the root Etendo directory. You can find more information about what build validations and modulescripts are, and how to create one, [here](../how-to-guides/how-to-create-build-validations-and-module-scripts.md).
