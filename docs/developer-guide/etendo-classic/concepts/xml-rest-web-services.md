...
For an Etendo instance running on http://livebuilds.openbravo.com/erp_pi_pgsql, the XSD can be retrieved through this request:
...
The REST Webservice functionality is tested using junit testcases. REST test cases can be found in the Etendo development project in the src-test folder and then in the org.openbravo.test.webservice package. The REST test cases give a first impression on how to do REST requests directly from Java incl.
