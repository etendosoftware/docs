...
DBSourceManager uses a mechanism which is called **Model filters**, to purposely remove some unwanted objects from the physical database model. These filters can be extended by modules. To know how, you can read [this document](../how-to-guides/how-to-exclude-database-physical-objects-from-model.md).
