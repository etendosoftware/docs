...
1. Add the following lines to the `gradle.properties` file:
    ...
    | **next.public.etendo.classic.host** | Backend URL (client-side) | URL that the browser uses for direct requests. In Docker hybrid mode, use `localhost` | `http://localhost:8080/etendo` | `https://your-domain.com/etendo` |
