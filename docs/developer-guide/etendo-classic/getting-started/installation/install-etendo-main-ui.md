...
1. Add the following lines to the `gradle.properties` file:
    ...
    ``` groovy title="gradle.properties"
        ...
        next.public.etendo.classic.host=http://localhost:8080/etendo
    ...
    | **next.public.etendo.classic.host** | Client-side URL that the browser uses to make direct requests to Etendo Classic. | URL that the browser uses for direct requests. In Docker hybrid mode, use `localhost` | `http://localhost:8080/etendo` | `https://your-domain.com/etendo` |
