...
The objective of this how-to is to show how you can define display logic for tabs, so its visibility will depend on the value of the fields of its ancestor tabs, of preferences and of system variables. The display logic will only be
...
![](../../../assets/developer-guide/etendo-classic/how-to-guides/How_To_Define_Display_Logic_For_Tabs-1.png){: .legacy-image-style}
...
If there is a reference the a field of a tab of a higher level, the name of the field should be placed between '@'. I.e., if we only want to show the Query tab of the Widget window when the selected widget is a Query widget, the
Query tab display logic can be defined as: `@Widget_Superclass_ID@='2A32CF26F3F64FE39C7F94E9D82497D1`.
