...
1. Click the Report Datasources icon  ![](../../../assets/developer-guide/etendo-classic/how-to-guides/how-to-create-a-report-with-ireport/how-to-create-a-report-with-ireport-2.png)
2. Click **New**
...
4. Fill all the fields:
    ...
    - **Username:** tad (you can check your username/password in `gradle.properties` configuration file)
    - **Password:** tad

5. Click Wizard button to generate the JDBC URL 
