---
title: How to Create a Table based on a User Defined Datasource
tags: 
    - Table
    - User Defined
    - Datasource 
...
!!!info
    Defining a datasource requires of quite a big effort (filtering, pagination, sorting and so on needs to be coded). If it is suitable for your needs, a [HQL Based Table](../how-to-guides/how-to-create-a-hql-based-table.md) can be used.  

  
##  Creating the Java Datasource

[This section](../concepts/datasources.md) describes how to create a Java Datasource, and provides [some examples](../concepts/datasources.md#datasource-examples).
...
[This section](../concepts/datasources.md#datasource-definition) describes how to define a datasource in the application dictionary.
...
[This section](../how-to-guides/how-to-create-a-table.md#registering-the-table-within-the-application-dictionary) describes how to define in the application dictionary tables based on database tables or views.
...
Once the table its columns have been defined, it is the Window's turn. Windows with tabs associated with datasource based tables are defined in the exact same way as with tabs associated with database table based tables. [This section](../how-to-guides/how-to-create-a-window.md) describes how to do it.
...
![](../../../assets/developer-guide/etendo-classic/how-to-guides/How_to_Create_a_Table_Based_on_a_User_Defined_Datasource-6.png){: .legacy-image-style}
...
![](../../../assets/developer-guide/etendo-classic/how-to-guides/How_to_Create_a_Table_Based_on_a_User_Defined_Datasource-7.png){: .legacy-image-style}
...
![](../../../assets/developer-guide/etendo-classic/how-to-guides/How_to_Create_a_Table_Based_on_a_User_Defined_Datasource-8.png){: .legacy-image-style}
