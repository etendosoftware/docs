---
title: How to implement Create New In Selectors
tags: 
    - implement
    - create new
    - selectors
...
![](../../../assets/developer-guide/etendo-classic/how-to-guides/How_to_implement_Create_New_In_Selectors-3.png){: .legacy-image-style}
