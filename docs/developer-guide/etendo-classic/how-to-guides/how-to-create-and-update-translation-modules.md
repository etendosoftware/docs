...
Module translation can be done by manually modifying the exported XML files, which is a convenient method for modules with few strings to translate, or by using the Etendo Copilot wizard, [Module Translation Creator](../../etendo-copilot/bundles/dev-assistant.md#module-translation-creator).
