...
All new developments must belong to a module that is not the _core_ module. Please follow the [How to create a module](how-to-create-a-module.md) section of the Modularity Developer's Manual to create a new module.
...
- _Data Package_ specifies to which java data package within the module the table will belong when used within [DAL](../concepts/data-access-layer.md) (Data Access Layer).
- _Name_ Defines the name that Etendo Classic uses to recognize the defined database table. This name is used in [REST webservices](../../concepts/xml-rest-web-services.md) and in the [Data Access Layer](../concepts/data-access-layer.md#entity-naming).
...
The name is used by the [Data Access Layer](../concepts/data-access-layer.md) and in [REST webservices](../../concepts/xml-rest-web-services.md). For specific columns (audit info, client/organization, active) it is important to be precise in the naming.
