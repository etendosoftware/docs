...
This example logs a line every time a window is loaded. You can find the code described below in the [org.openbravo.platform.features](../../../assets/developer-guide/etendo-classic/how-to-guides/org.openbravo.platform.features.zip) module.
