...
In the case of PRESAVE and POSTSAVE the **extraParameters** argument will
...
Note that if the e-mail is not valid, we do not call
...
The record will **not** be saved if the storage bin row is not 0. Otherwise,
