...
- **Library Name**: `[commons-beanutils]`
  - **Old Version**: 1.8.3
  - **New Version**: 1.9.4
...
- **Library Name**: `[hibernate-core]`
  - **Old Version**: 5.4.2.Final
  - **New Version**: 5.6.15.Final
  - **Notable Changes**:
...
- **Library Name**: `[istack-commons-runtime]`
  - **Old Version**: 3.0.7
  - **New Version**: 4.2.0

- **Library Name**: `[jasperreports]`
  - **Old Version**: 6.0.0
  - **New Version**: 6.17.0
  - **Notable Changes**:
      - [Releases Page – GitHub](https://github.com/Jaspersoft/jasperreports/releases)

- **Library Name**: `[jasperreports-fonts]`
  - **Old Version**: 6.0.0
  - **New Version**: 6.17.0
...
> **Note**: Refer to each library’s release notes for more detailed information on changes and how they might affect your system.
   ...
   - **Library Name**: `[itext-pdfa]`
      - **Version**: 5.5.0

   - **Library Name**: `[itextpdf]`
      - **Version**: 5.5.0
