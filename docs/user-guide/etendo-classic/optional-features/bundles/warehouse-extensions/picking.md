...
!!! info "Advanced Warehouse Management Integration"
    When the [Advanced Warehouse Management](advanced-warehouse-management.md) module is installed, the picking process can be managed through tasks, offering greater control and traceability. The system runs automatic background processes that create and manage picking tasks, and displays warning messages at different stages with links to the Task window where users can review process logs and execution details.
    
    This integration enables:
    
    - Complete picking process management from the ERP and mobile devices
    - Automatic task creation for picking and packing operations
    - Real-time process monitoring and log verification
    - Enhanced traceability and control over warehouse operations
    
    For more information about the picking process with tasks and mobile device integration, visit [Advanced Warehouse Management](advanced-warehouse-management.md#picking-tasks).
