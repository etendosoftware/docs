...
1. Install Etendo Mobile on a device. To do so, follow the instructions in [Getting Started - Etendo Mobile](../../../../etendo-mobile/getting-started.md)
...
The process starts in Etendo when a [Picking List is created](../../../optional-features/bundles/warehouse-extensions/picking.md#picking-list-generation) from the sales order, provided that the Task Type Warehouse Picking or Warehouse Picking & Packing is active and a Warehouse Picking task is created, as explained in the Tasks section of the [Initial Setup](#initial-setup).
...
![](../../../../../assets/user-guide/etendo-classic/optional-features/bundles/warehouse-extensions/picking-2.jpg)
...
1. The warehouse operator must **select a card** to access the corresponding task. To select the task, scroll or enter key data in the search engine.

2. Once the task is selected, a window opens with the list of products to pick. This window has the **start picking** button, information on the number of products scanned or loaded, the reference picking list number and the list of products to be scanned.

3. To start the process, **click on the Start Picking** button located at the top, once this is done, the task goes to In Progress status.
...
![](../../../../../assets/user-guide/etendo-classic/optional-features/bundles/warehouse-extensions/picking-4.png)
...
Once part or all of the products have been picked, the **Finish** button is enabled. A confirmation message is displayed to confirm that picking has been completed.
...
When accessing Etendo Mobile and selecting the **Packing** menu, the packing main screen with the title Tasks (N) is displayed, where N represents the number of available tasks. 
...
- A list of cards, where each card represents a picking task and includes the following information:
    ...
    ![](../../../../../assets/user-guide/etendo-classic/optional-features/bundles/warehouse-extensions/packing-2.jpg)

#### Product Packing

1. The warehouse operator must **select a card** to access the corresponding task. To select the task, scroll or enter key data in the search engine.

2. When selecting a task, a screen opens with the picking list number and the **Start Packing** button.
