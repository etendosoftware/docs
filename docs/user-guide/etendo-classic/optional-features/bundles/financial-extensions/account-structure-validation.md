---
Title: Account Structure Validation
Tags:
...
The module includes the **"Enable Subaccount Validation"** system preference, which is configured to `YES` by default, ensuring the validation is active from the moment the module is installed.
...
![Element Value Tab - Exclude from Validation](../../../../../assets/user-guide/etendo-classic/optional-features/bundles/financial-extensions/account-structure-validation/account-structure-validation.png)
