...
!!! info
    For more information about the module configuration visit the [Developer Guide](../../../../../developer-guide/etendo-classic/bundles/platform/overview.md#etendo-advanced-security).
