...
-   Create a sales representative. The way to do that is:
    ...
    - Create a [Product](../../../../etendo-classic/basic-features/master-data-management/master-data/product.md#product) and get it part of a **Price List** without pricing information as part of the required concept when the commission purchase invoice is created. 
