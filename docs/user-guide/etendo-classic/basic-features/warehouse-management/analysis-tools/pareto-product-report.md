...
To use pre-aggregated data, run the [Valued Stock Report](valued-stock-report.md) first. Once that report has been generated, the Pareto Product Report will automatically reuse its results, reducing load time. If you skip this step, the report will still run but may be slower in high-volume environments.
