...
- Remittance Type: It is necessary to define a remittance type with a certain payment method in the *Remittance Type* window.
    ...
    !!! info
        For more information, visit [Remittance Type window](../setup/remittance-type.md).
...
![Remittance window](../../../../../../assets/user-guide/etendo-classic/basic-features/financial-management/receivables-and-payables/transactions/remittance/remittance-2.png)
...
!!! info
    If the Automated Remittance module in the Financial Extensions Bundle is installed, this process includes the date setting and the settlement of the remittance.  For more information, visit [the Automated Remittance user guide](../../../../optional-features/bundles/financial-extensions/automated-remittance.md).
...
!!! info
    For more information, visit [the Automated Remittance user guide](../../../../optional-features/bundles/financial-extensions/automated-remittance.md).
