...
These reports need to be configured prior to be launched in the [Balance Sheet and P&L Structure Setup](../setup/balance-sheet-and-pl-structure-setup.md) window.
